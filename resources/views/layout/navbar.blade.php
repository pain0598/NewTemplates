  ...
  <div class="container">
    <ul class="nav">
      ...
      <li class="nav-item with-sub">
        ...
        <div class="sub-item">
          <ul>
            <li><a href="form-elements.html">General Settings</a></li>
            <li><a href="form-layouts.html">Logo & Favicon</a></li>
            <li><a href="form-validation.html"> Pusher Setting</a></li>
            <li><a href="form-wizards.html">Sections</a></li>
            <li><a href="{{ route('manage-footer')}}"> Manage Footer </a></li>
          </ul>
        </div><!-- dropdown-menu -->
      </li>
    </ul>
